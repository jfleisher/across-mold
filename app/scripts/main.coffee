require.config
  ...
  paths:
    ...
    # helpers - underscore mixins and such
  ...
  'mandrill'
    ...
    @getStorageObject = () ->
      try
        ...
        storageObj = new @tempStorageObject()
      return storageObj
    ...
    #handle localStorage for Safari Private browsing
    Parse.localStorage = @getStorageObject()
